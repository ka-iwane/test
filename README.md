...
- QR発行前の6チーム名設定、発行後のチーム名変更
- 発行済みチームごとのミッション登録・停止・再開
- QR受付の停止・再開
- 参加登録端末の確認・停止・再開
- ミッションに紐づく写真付き達成レポートの確認・削除

チームのQRコードを発行した後、「ミッション管理」で対象チーム、ミッション名、達成条件を登録します。参加者の達成報告画面には、自分のチームで公開中のミッションだけが選択肢として表示されます。
